		...
		<section id="content">
			<?php if( have_posts() ) : while( have_posts() ) : the_post(); ?>
				...
				<div class="thb-text">
						...
						<?php if( get_field('fourth_column') & get_field('third_column') & get_field('second_column')): //FOUR COLUMNS ?>

							<div class="col content-one-fourth">
								<?php the_content(); ?>
							</div>
							...
							<div class="col content-one-fourth">
								<p><?php the_field('third_column') ?></p>
							</div>

							<div class="col content-one-fourth">
								<p><?php the_field('fourth_column') ?></p>
							</div>

						<?php elseif( get_field('third_column') & get_field('second_column')): //THREE COLUMNS ?>
						...
						<?php elseif( get_field('second_column') ):  //TWO COLUMNS?>

						  <div class="col content-one-half">
					      		<p><?php the_content(); ?></p>
					      </div>
