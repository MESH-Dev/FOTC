...
?>
				...
				<div class="wrapper">
					...
					<div class="callout">
						<ul>
							...
							<li>
								<a href="<?php the_permalink(); ?>" class="title-home"><?php the_field('home_page_callout_title'); ?></a>
								<div class="text-home"><?php the_field('home_page_callout'); ?></div>
								<?php if( get_field('home_page_callout_link') ):  //TWO COLUMNS?>
									<a class="read-more" href="<?php the_field('home_page_callout_link'); ?>">Read more&raquo;</a>
								<?php endif; ?>
							</li>
							<br/>
						</ul>
		...
		<script>
		    ...
		    var hammertime = Hammer(element).on("tap", function(event) {
		        $('#re-nav').toggle('slide', {direction:'up'}, 300);
		    });
